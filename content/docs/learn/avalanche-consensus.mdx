...
description: Consensus is the task of getting a group of computers (a.k.a. nodes) to come to an agreement on a decision. In blockchain, this means that all the participants in a network have to agree on the changes made to the shared ledger. This agreement is reached through a specific process, a consensus protocol, that ensures that everyone sees the same information and that the information is accurate and trustworthy.
---
...
Conceptual Overview[​](#conceptual-overview "Direct link to heading")
---------------------------------------------------------------------
...
Deep Dive Into Avalanche Consensus[​](#deep-dive-into-avalanche-consensus "Direct link to heading")
---------------------------------------------------------------------------------------------------
<iframe
  width="560"
  height="315"
...
### Intuition[​](#intuition "Direct link to heading")
...
### Snowball[​](#snowball "Direct link to heading")
...
#### Algorithm[​](#algorithm "Direct link to heading")
...
#### Algorithm Explained[​](#algorithm-explained "Direct link to heading")
...
### Blocks[​](#blocks "Direct link to heading")
...
### Optimizations[​](#optimizations "Direct link to heading")
...
### Big Ideas[​](#big-ideas "Direct link to heading")
...
### Loose Ends[​](#loose-ends "Direct link to heading")
...
### Other Observations[​](#other-observations "Direct link to heading")
...
Why Do We Care?[​](#why-do-we-care "Direct link to heading")
------------------------------------------------------------
