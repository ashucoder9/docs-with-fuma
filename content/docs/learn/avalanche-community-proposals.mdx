---
title: What is an Avalanche Community Proposal?
sidebarTitle: Avalanche Community Proposals
---
<Card
  icon="github"
...
ACP Tracks[​](#acp-tracks "Direct link to heading")
---------------------------------------------------
...
ACP Statuses[​](#acp-statuses "Direct link to heading")
-------------------------------------------------------
...
ACP Workflow[​](#acp-workflow "Direct link to heading")
-------------------------------------------------------

### Step 0: Think of a Novel Improvement to Avalanche[​](#step-0-think-of-a-novel-improvement-to-avalanche "Direct link to heading")
...
### Step 1: Post Your Idea to [GitHub Discussions](https://github.com/avalanche-foundation/ACPs/discussions/categories/ideas)[​](#step-1-post-your-idea-to-github-discussions "Direct link to heading")
...
### Step 2: Propose an ACP via [Pull Request](https://github.com/avalanche-foundation/ACPs/pulls)[​](#step-2-propose-an-acp-via-pull-request "Direct link to heading")
...
### Step 3: Build Consensus on [GitHub Discussions](https://github.com/avalanche-foundation/ACPs/discussions/categories/discussion) and Provide an Implementation (if Applicable)[​](#step-3-build-consensus-on-github-discussions-and-provide-an-implementation-if-applicable "Direct link to heading")
...
### Step 4: Mark ACP as `Implementable` via [Pull Request](https://github.com/avalanche-foundation/ACPs/pulls)[​](#step-4-mark-acp-as-implementable-via-pull-request "Direct link to heading")
...
### \[Optional\] Step 5: Mark ACP as `Stale` via [Pull Request](https://github.com/avalanche-foundation/ACPs/pulls)[​](#optional-step-5-mark-acp-as-stale-via-pull-request "Direct link to heading")
...
What belongs in a successful ACP?[​](#what-belongs-in-a-successful-acp "Direct link to heading")
------------------------------------------------------------------------------------------------
...
### ACP "Straw Poll"[​](#acp-straw-poll "Direct link to heading")
...
### ACP Formats and Templates[​](#acp-formats-and-templates "Direct link to heading")
...
### Auxiliary Files[​](#auxiliary-files "Direct link to heading")
...
### Waived Copyright[​](#waived-copyright "Direct link to heading")
...
Proposals[​](#proposals "Direct link to heading")
-------------------------------------------------
