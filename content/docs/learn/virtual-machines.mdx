...
To get started, create a VM out-of-the-box with the [Subnet-EVM](/build/subnets/c-chain--subnet) in Solidity, or design a custom VM with languages like Golang, Rust, and many more.
...
Both C-Chain and the Subnet-EVM are compatible with Ethereum tooling like Remix, Core, MetaMask, ThirdWeb, and more. To learn more about smart contract support, click [here](/build/dapps/end-to-end/launch-ethereum).
