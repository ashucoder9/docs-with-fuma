---
title: How to Build a Simple Golang VM
sidebarTitle: Simple Golang VM
---
...
TimestampVM Implementation[​](#timestampvm-implementation "Direct link to heading")
-----------------------------------------------------------------------------------
...
#### Verify[​](#verify "Direct link to heading")
...
#### Accept[​](#accept "Direct link to heading")
...
#### Reject[​](#reject "Direct link to heading")
...
#### Block Field Methods[​](#block-field-methods "Direct link to heading")
...
#### Helper Functions[​](#helper-functions "Direct link to heading")
...
##### `initGenesis`[​](#initgenesis "Direct link to heading")
...
#### CreateHandlers[​](#createhandlers "Direct link to heading")

Registered handlers defined in `Service`. See [below](/build/virtual-machines/golang-vms/simple-golang-vm#api) for more on APIs.
...
#### CreateStaticHandlers[​](#createstatichandlers "Direct link to heading")

Registers static handlers defined in `StaticService`. See [below](/build/virtual-machines/golang-vms/simple-golang-vm#static-api) for more on static APIs.
...
#### BuildBock[​](#buildbock "Direct link to heading")
...
#### NotifyBlockReady[​](#notifyblockready "Direct link to heading")
...
#### `proposeBlock`[​](#proposeblock "Direct link to heading")
...
#### ParseBlock[​](#parseblock "Direct link to heading")
...
#### NewBlock[​](#newblock "Direct link to heading")
...
#### SetPreference[​](#setpreference "Direct link to heading")
...
#### Other Functions[​](#other-functions "Direct link to heading")
...
### Static API[​](#static-api "Direct link to heading")
...
/timestampvm/static\_service.go
...
#### Encode[​](#encode "Direct link to heading")
...
```swift /timestampvm/static\_service.go
...
#### Decode[​](#decode "Direct link to heading")
...
#### `timestampvm.getBlock`[​](#timestampvmgetblock "Direct link to heading")

Get a block by its ID. If no ID is provided, get the latest block.

##### `getBlock` Signature[​](#getblock-signature "Direct link to heading")
...
##### `getBlock` Example Call[​](#getblock-example-call "Direct link to heading")
...
##### `getBlock` Example Response[​](#getblock-example-response "Direct link to heading")
...
##### `getBlock` Implementation[​](#getblock-implementation "Direct link to heading")


```swift /timestampvm/service.go
...
#### `timestampvm.proposeBlock`[​](#timestampvmproposeblock "Direct link to heading")

Propose the next block on this blockchain.

##### `proposeBlock` Signature[​](#proposeblock-signature "Direct link to heading")
...
##### `proposeBlock` Example Call[​](#proposeblock-example-call "Direct link to heading")
...
###### `proposeBlock` Example Response[​](#proposeblock-example-response "Direct link to heading")
...
##### `proposeBlock` Implementation[​](#proposeblock-implementation "Direct link to heading")
...
### Plugin[​](#plugin "Direct link to heading")
...
### Executable Binary[​](#executable-binary "Direct link to heading")
...
### VM Aliases[​](#vm-aliases "Direct link to heading")
...
### Installing a VM[​](#installing-a-vm "Direct link to heading")

AvalancheGo searches for and registers plugins under the `plugins` [directory](/nodes/configure/configs--flags#--plugin-dir-string).
...
#### Node Is Not Running[​](#node-is-not-running "Direct link to heading")

If your node isn't running yet, you can install all virtual machines under your `plugin` directory by starting the node.

#### Node Is Already Running[​](#node-is-already-running "Direct link to heading")
...
Now, this VM's static API can be accessed at endpoints `/ext/vm/timestampvm` and `/ext/vm/timestamp`. For more details about VM configs, see [here](/nodes/configure/configs--flags#virtual-machine-vm-configs).
