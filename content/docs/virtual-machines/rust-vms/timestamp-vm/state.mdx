...
State Definition[​](#state-definition "Direct link to heading")
---------------------------------------------------------------
...
`State` Functions[​](#state-functions "Direct link to heading")
---------------------------------------------------------------
...
```swift timestampvm/src/state/mod.rs
impl State {
