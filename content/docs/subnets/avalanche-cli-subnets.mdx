...
[Install Avalanche CLI](/tooling/guides/install-avalanche-cli)
...
This command requires the node's BLS key and proof of possession key, more information regarding BLS can be found [here](/api-reference/p-chain/transaction-format#proof-of-possession).
