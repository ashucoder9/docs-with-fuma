...
If not yet installed, install `Avalanche-CLI` following the tutorial at [Avalanche-CLI installation](/docs/tooling/guides/install-avalanche-cli)
...
The final question is asking for precompiles. Precompiles are powerful customizations of your EVM. Read about them at [precompiles](/docs/subnets/manage-subnets/upgrade/customize-subnet#precompiles).
