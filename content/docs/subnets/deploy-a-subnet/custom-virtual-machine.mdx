...
description: Learn how to create a Subnet with a custom virtual machine and deploy it locally.
---
...
Open a text editor and copy the preceding text into a file called `custom_genesis.json`. For full breakdown of the genesis file, see the [Genesis File](subnets/upgrade/customize-subnet.mdx#genesis).
