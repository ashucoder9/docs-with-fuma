---
title: Build Your First Subnet
description: This tutorial walks you through the process of using Avalanche-CLI to create a Subnet, deploy it on a local network, and add to Core wallet.
---
...
For more detailed installation instructions, see [Avalanche-CLI Installation](/docs/tooling/guides/install-avalanche-cli).
...
If all worked as expected, your balance should read 1 million tokens. Your Subnet is ready for action. You might want to try to [Deploy a Smart Contract on Your Subnet-EVM Using Remix and Core](/docs/subnets/manage-subnets/add-utility/deploy-smartcontract).

![Subnet in Core](/images/deploy-subnet7.png)
...
Once you've developed a stable Subnet you like, see [Create an EVM Subnet on Fuji Testnet](/docs/subnets/deploy-a-subnet/fuji-testnet) to take your Subnet one step closer to production.
