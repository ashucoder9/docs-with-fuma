---
title: Parameters
description: Learn about the different parameters of Elastic Subnets.
---

Avalanche Permissioned Subnets can be turned into Elastic Subnets via the `TransformSubnetTx` transaction. `TransformSubnetTx` specifies a set of structural parameters for the Elastic Subnet.
