...
[X-Chain](/docs/api-reference/x-chain/api.md), [P-Chain](/docs/api-reference/p-chain/api.md),
[C-Chain](/docs/api-reference/c-chain/api.md), and full archival for the Primary Network.
However, it doesn't support [Index APIs](/docs/api-reference/index-api.md), which includes
