...
Adding Avalanche-CLI to Your PATH[​](#adding-avalanche-cli-to-your-path "Direct link to heading")
-------------------------------------------------------------------------------------------------
...
Checking Your Installation[​](#checking-your-installation "Direct link to heading")
-----------------------------------------------------------------------------------
