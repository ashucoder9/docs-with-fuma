---
title: How to Deploy a Subnet on a Local Network
sidebarTitle: Deploy on a Local Network
---
...
*   You have [created a Subnet configuration](/build/subnets/build-first-subnet#create-your-subnet-configuration)
