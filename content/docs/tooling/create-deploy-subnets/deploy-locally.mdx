...
description: This guide shows you how to deploy a Subnet to a local Avalanche network.
---
...
- You have [created a Subnet configuration](/docs/subnets/build-first-subnet#create-your-subnet-configuration)
...
### Deploying Multiple Subnets[​](#deploying-multiple-subnets "Direct link to heading")
...
Redeploying the Subnet[​](#redeploying-the-subnet "Direct link to heading")
---------------------------------------------------------------------------
