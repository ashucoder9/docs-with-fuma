---
title: AvalancheJS Overview
sidebarTitle: AvalancheJS
---
...
First, make sure you add the environment variables in a `.env` file at the root of the project.

Fill in the private key for your account, and the C-Chain and X-Chain addresses.

![avalanchejs2](https://docs.avax.network/assets/images/avalanchejs-3-e05d1db16879ce07f00a1078b624497c.png)
