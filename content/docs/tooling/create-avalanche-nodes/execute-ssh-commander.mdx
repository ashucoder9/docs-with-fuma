---
title: Execute a SSH command on a Cluster
...
*   A Cluster managed by CLI, either a [Fuji Cluster using AWS](/tooling/create-avalanche-nodes/run-validators-aws), a [Fuji Cluster using GCP](/tooling/create-avalanche-nodes/run-validators-gcp), or a [Devnet](/tooling/create-avalanche-nodes/setup-devnet),
