...
flags for `devnet wiz` command can be found [here](/docs/tooling/avalanche-cli.md#node-devnet-wiz).
...
- `<genesisPath>` [Genesis File](/docs/tooling/cli-create-nodes/upload-a-custom-vm-to-cloud#genesis-file)
- `<chainConfigPath>` [Blockchain Config](/docs/tooling/cli-create-nodes/upload-a-custom-vm-to-cloud#blockchain-config)
- `<subnetConfigPath>` [Subnet Config](/docs/tooling/cli-create-nodes/upload-a-custom-vm-to-cloud#subnet-config)
- `<avagoConfigPath>` [AvalancheGo Config](/docs/tooling/cli-create-nodes/upload-a-custom-vm-to-cloud#avalanchego-flags)
