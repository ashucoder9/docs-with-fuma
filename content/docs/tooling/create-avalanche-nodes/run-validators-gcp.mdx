---
title: Run an Avalanche Validator on GCP with One Avalanche-CLI Command
sidebarTitle: Run Avalanche on GCP
---
...
The command will next ask whether you want to set up monitoring for your nodes. If you choose to set up monitoring, you can either set up monitoring on a separate GCP instance or on the same instance.
