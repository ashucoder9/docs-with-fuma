...
The following diagram is a simplified view of the high level architecture of the tool: ![ANR architecture](/images/network-runner1.png)
...
### Run Queries[​](#run-queries "Direct link to heading")

#### Ping the Server[​](#ping-the-server "Direct link to heading")
...
#### Start a New Avalanche Network with Five Nodes[​](#start-a-new-avalanche-network-with-five-nodes "Direct link to heading")
...
See the [Avalanche-CLI documentation](/build/subnets/deploy-a-subnet/local-network) for details about how to create and run Subnets with our _Avalanche-CLI_ tool.
...
#### Wait for All the Nodes in the Cluster to Become Healthy[​](#wait-for-all-the-nodes-in-the-cluster-to-become-healthy "Direct link to heading")
...
#### Get API Endpoints of All Nodes in the Cluster[​](#get-api-endpoints-of-all-nodes-in-the-cluster "Direct link to heading")
...
#### Query Cluster Status from the Server[​](#query-cluster-status-from-the-server "Direct link to heading")
...
#### Stream Cluster Status[​](#stream-cluster-status "Direct link to heading")
...
#### Remove (Stop) a Node[​](#remove-stop-a-node "Direct link to heading")
...
#### Restart a Node[​](#restart-a-node "Direct link to heading")
...
#### Add a Node[​](#add-a-node "Direct link to heading")
...
#### Terminate the Cluster[​](#terminate-the-cluster "Direct link to heading")
...
Using Avalanche Network as a Library[​](#using-avalanche-network-as-a-library "Direct link to heading")
-------------------------------------------------------------------------------------------------------
...
### Creating Custom Networks[​](#creating-custom-networks "Direct link to heading")
