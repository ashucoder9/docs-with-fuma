...
---
API calls with Data Visualization[​](#api-calls-with-data-visualization "Direct link to heading")
-------------------------------------------------------------------------------------------------
...
Please check out [Setting up Postman](/tooling/avalanche-go-postman-collection/setting-up-postman#setup) and [Making API Calls](/tooling/avalanche-go-postman-collection/making-api-calls) beforehand, as this guide assumes that the user has already gone through these steps.
...
1.  After [installing Postman](/tooling/avalanche-go-postman-collection/setting-up-postman#postman-installation) and importing the [Avalanche collection](/tooling/avalanche-go-postman-collection/setting-up-postman#collection-import), choose an API to make the call.
