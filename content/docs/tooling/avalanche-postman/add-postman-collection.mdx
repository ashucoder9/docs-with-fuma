---
title: Adding Postman Collection
---
...
If you have completed the tutorial, you are now able to quickly [issue API calls](/tooling/avalanche-go-postman-collection/making-api-calls) to your node without messing with the curl commands in the terminal. This allows you to quickly see the state of your node, track changes or double-check the health or liveness of your node.
