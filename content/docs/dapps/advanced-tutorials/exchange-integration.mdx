...
for C-Chain API [here](/docs/api-reference/c-chain/api.md).
...
- [Core and Remix](/docs/dapps/smart-contracts/remix-deploy.md)
- [thirdweb](/docs/dapps/smart-contracts/toolchains/thirdweb.md)
- [Hardhat](/docs/dapps/smart-contracts/toolchains/hardhat.md)
