...
running, you can use the [node installation script](/docs/nodes/run/with-installer/installing-avalanchego.md) that automates installing
and updating AvalancheGo node as a `systemd` service on Linux, using prebuilt
binaries.

### Configuring an Avalanche Node

All configuration options and their default values are described [here](/docs/nodes/configure/avalanchego-config-flags.md).
...
[here](/docs/nodes/configure/chain-configs/C.md).
...
for C-Chain API [here](/docs/api-reference//avalanchego/c-chain/api.md).
...
- The detailed dynamic gas fee can be found [here](/docs/api-reference//standards/guides/txn-fees#c-chain-fees).
...
- [Core and Remix](/docs/build/dapp/smart-contracts/remix-deploy.md)
- [thirdweb](/docs/build/dapp/smart-contracts/toolchains/thirdweb.md)
- [Hardhat](/docs/build/dapp/smart-contracts/toolchains/hardhat.md)
...
[here](/docs/learn/avalanche/avalanche-platform.md) (out of scope for a
