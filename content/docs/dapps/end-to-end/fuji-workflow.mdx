...
![Settings image 1](/images/c-chain-ERC20/settings1.png)

Here, turn on the **Testnet Mode** feature. This will automatically make Core switch to
Fuji Testnet.

![Settings image 2](/images/c-chain-ERC20/settings2.png)
...
[AvalancheJS](/docs/tooling/avalanchejs-overview.md). Mnemonics enable us to encode
...
![Requesting AVAX](/images/fuji-workflow/faucet1.png)
...
![Receiving AVAX](/images/fuji-workflow/faucet2.png)
...
![Transaction details](/images/faucet-fuji-wf-alt-tx1.png)
...
![1st derived address balance](/images/faucet-fuji-wf-alt-balance.png)
...
![Transaction details](/images/fuji-wf-alt-tx-2.png)
...
![Access the wallet](/images/fuji-wf-alt-enter-key.png)

The balance is correct and the address is the 1st derived address.

![Core extension balance](/images/fuji-wf-wallet-alt-info.png) ![3rd derived BIP44 address](/images/fuji-wf-alt-wallet-address.png)
...
![Wallet derived addresses](/images/fuji-wf-alt-wallet-address-2.png)
![Wallet derived addresses2](/images/fuji-wf-alt-wallet-address-3.png)  
![Wallet derived addresses3](/images/fuji-wf-alt-wallet-addresses.png)
...
See [here.](/docs/tooling/rpc-providers.md)