...
C-Chain exposes the [same API](/docs/api-reference//avalanchego/c-chain/api.md) as
...
In your application's web interface, follow [this to add Avalanche programmatically](/docs/build/dapp/advanced/add-avalanche-programmatically.md#core).
...
[add Avalanche programmatically](/docs/build/dapp/advanced/add-avalanche-programmatically.md#metamask)
...
For more information, see [documentation](/docs/tooling/rpc-providers.md).
...
[here](/docs/nodes/run/node-manually.md) is a tutorial that shows
...
[installer script](/docs/nodes/run/with-installer/installing-avalanchego.md) to install the node as a
...
[here](/docs/nodes/configure/avalanchego-config-flags.md). But unless you have
...
C-Chain [here](/docs/nodes/configure/chain-configs/C.md) as well
...
Default config values for the C-Chain can be seen [here](/docs/nodes/configure/chain-configs/C.md).
...
For more information, see [documentation](/docs/tooling/network-runner.md).
...
There is a
[tutorial](/docs/build/dapp/smart-contracts/remix-deploy.md)
for using Remix to deploy smart contracts on Avalanche. It relies on Core
for access to the Avalanche network.

### thirdweb

You can also use thirdweb to test and deploy smart contracts on Avalanche. Find out how in this [tutorial](/docs/build/dapp/smart-contracts/toolchains/thirdweb.md).
...
For more information see [this doc](/docs/build/dapp/smart-contracts/toolchains/hardhat.md).
...
See
[this](/docs/build/dapp/smart-contracts/verification/verify-hardhat.md)
