...
C-Chain exposes the [same API](/docs/api-reference/c-chain/api.md) as
...
In your application's web interface, follow [this to add Avalanche programmatically](/docs/dapps/advanced/add-avalanche-programmatically.md#core).
...
[add Avalanche programmatically](/docs/dapps/advanced/add-avalanche-programmatically.md#metamask)
...
There is a
[tutorial](/docs/dapps/smart-contracts/remix-deploy.md)
for using Remix to deploy smart contracts on Avalanche. It relies on Core
for access to the Avalanche network.

### thirdweb

You can also use thirdweb to test and deploy smart contracts on Avalanche. Find out how in this [tutorial](/docs/dapps/smart-contracts/toolchains/thirdweb.md).
...
For more information see [this doc](/docs/dapps/smart-contracts/toolchains/hardhat.md).
...
See
[this](/docs/dapps/smart-contracts/verification/verify-hardhat.md)
