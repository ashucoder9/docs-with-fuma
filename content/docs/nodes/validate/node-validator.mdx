...
The [Primary Network](/docs/learn/avalanche/avalanche-platform.md)
...
You've completed [Run an Avalanche Node](/docs/nodes/run/node-manually.md) and are familiar with
[Avalanche's architecture](/docs/learn/avalanche/avalanche-platform.md). In this
tutorial, we use [AvalancheJS](/docs/tooling/avalanchejs-overview.md) and
[Avalanche's Postman collection](/docs/tooling/avalanchego-postman-collection/setup.md) 
...
Get this info by calling [`info.getNodeID`](/docs/api-reference//avalanchego/info-api.md#infogetnodeid):
...
Fill out the staking parameters. They are explained in more detail in [this doc](/docs/nodes/validate/how-to-stake.md). When you've 
...
Calling
[`platform.getPendingValidators`](/docs/api-reference//avalanchego/p-chain/api.md#platformgetpendingvalidators)
...
You can also call
[`platform.getCurrentValidators`](/docs/api-reference//avalanchego/p-chain/api.md#platformgetcurrentvalidators)
...
We can also add a node to the validator set using [AvalancheJS](/docs/tooling/avalanchejs-overview.md).
