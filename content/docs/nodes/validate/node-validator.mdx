...
Get this info by calling [`info.getNodeID`](/docs/api-reference/info-api.md#infogetnodeid):
...
Calling
[`platform.getPendingValidators`](/docs/api-reference/p-chain/api.md#platformgetpendingvalidators)
...
You can also call
[`platform.getCurrentValidators`](/docs/api-reference/p-chain/api.md#platformgetcurrentvalidators)
