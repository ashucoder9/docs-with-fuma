---
title: Run an Avalanche Node Manually
sidebarTitle: Manually
---
...
*   If you're just interested in setting up a node for staking, it's recommended to follow the [AvalancheGo Install Script](/nodes/run-a-node/using-install-script/installing-avalanche-go) tutorial.
