---
title: Run an Avalanche Node with Latitude.sh
...
After gaining access, we'll need to set up our Avalanche node. To do this, follow the instructions here to install and run your node [Set Up Avalanche Node With Installer](/nodes/run-a-node/using-install-script/installing-avalanche-go).
