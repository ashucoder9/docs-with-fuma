---
title: Installing AvalancheGo Using the Script
sidebarTitle: Installing AvalancheGo
---
Running the Script[​](#running-the-script "Direct link to heading")
-------------------------------------------------------------------
...
Post Installation[​](#post-installation "Direct link to heading")
-----------------------------------------------------------------
