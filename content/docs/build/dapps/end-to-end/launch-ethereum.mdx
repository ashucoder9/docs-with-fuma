---
title: Launch an Ethereum Dapp on Avalanche
sidebarTitle: Launch an Ethereum Dapp
---
...
Accessing Avalanche C-Chain[​](#accessing-avalanche-c-chain "Direct link to heading")
-------------------------------------------------------------------------------------
...
### Through Core[​](#through-core "Direct link to heading")
...
### Through MetaMask[​](#through-metamask "Direct link to heading")
...
### Using the Public API Nodes or RPC Endpoints[​](#using-the-public-api-nodes-or-rpc-endpoints "Direct link to heading")
...
#### Running an Archival Node[​](#running-an-archival-node "Direct link to heading")
...
#### Running a Node in Debug Mode[​](#running-a-node-in-debug-mode "Direct link to heading")
...
#### Example C-Chain Config File[​](#example-c-chain-config-file "Direct link to heading")
...
### Running a Local Test Network[​](#running-a-local-test-network "Direct link to heading")
...
Developing and Deploying Contracts[​](#developing-and-deploying-contracts "Direct link to heading")
---------------------------------------------------------------------------------------------------
...
### Remix[​](#remix "Direct link to heading")
...
### thirdweb[​](#thirdweb "Direct link to heading")
...
### Hardhat[​](#hardhat "Direct link to heading")
...
Avalanche Explorer[​](#avalanche-explorer "Direct link to heading")
-------------------------------------------------------------------
...
Contract Verification[​](#contract-verification "Direct link to heading")
-------------------------------------------------------------------------
...
Contract Security Checks[​](#contract-security-checks "Direct link to heading")
-------------------------------------------------------------------------------
...
Gotchas and Things to Look out For[​](#gotchas-and-things-to-look-out-for "Direct link to heading")
---------------------------------------------------------------------------------------------------
...
### Measuring Time[​](#measuring-time "Direct link to heading")
...
### Finality[​](#finality "Direct link to heading")
...
### Using `eth_newFilter` and Related Calls with the Public API[​](#using-eth_newfilter-and-related-calls-with-the-public-api "Direct link to heading")
