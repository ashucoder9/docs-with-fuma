---
title: Sending Transactions with Dynamic Fees using JavaScript
sidebarTitle: Dynamic Gas Fees
---
Overview[​](#overview "Direct link to heading")
-----------------------------------------------

The objective of this document is to provide and explain sending transactions with dynamic fees using JavaScript. Make sure you have followed [the tutorial on adjusting the dynamic fees using MetaMask](/build/dapps/advanced-tutorials/manually-adjust-gas-price). There, we have explained the key concepts related to dynamic fees and EIP1559 type of transactions.
...
*   Basic understanding of [dynamic fee transactions](/build/dapps/advanced-tutorials/manually-adjust-gas-price#good-to-know-keywords-and-concepts)
...
Setting up Environment and Project[​](#setting-up-environment-and-project "Direct link to heading")
---------------------------------------------------------------------------------------------------
...
Importing Dependencies and Private Key[​](#importing-dependencies-and-private-key "Direct link to heading")
-----------------------------------------------------------------------------------------------------------
...
Setting up HTTP Provider Connected with Fuji Network[​](#setting-up-http-provider-connected-with-fuji-network "Direct link to heading")
---------------------------------------------------------------------------------------------------------------------------------------
...
Setting up C-Chain APIs for Estimating Base and Priority Fees[​](#setting-up-c-chain-apis-for-estimating-base-and-priority-fees "Direct link to heading")
---------------------------------------------------------------------------------------------------------------------------------------------------------
...
Setting up Wallet[​](#setting-up-wallet "Direct link to heading")
-----------------------------------------------------------------
...
Function for Estimating Max Fee and Max Priority Fee[​](#function-for-estimating-max-fee-and-max-priority-fee "Direct link to heading")
---------------------------------------------------------------------------------------------------------------------------------------
...
Function to Create, Sign and Send Transaction[​](#function-to-create-sign-and-send-transaction "Direct link to heading")
------------------------------------------------------------------------------------------------------------------------
...
Calling the `sendAVAX()` Function[​](#calling-the-sendavax-function "Direct link to heading")
---------------------------------------------------------------------------------------------
...
Reissuance of Stuck Transaction[​](#reissuance-of-stuck-transaction "Direct link to heading")
---------------------------------------------------------------------------------------------
