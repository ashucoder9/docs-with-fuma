---
title: Add Avalanche Network Programmatically
sidebarTitle: Add  Network Programmatically
description: This document shows how to integrate Avalanche Network with your Dapp, either by Core or MetaMask.
---

Core[​](#core "Direct link to heading")
---------------------------------------
...
### EIP-3035 & MetaMask[​](#eip-3035--metamask "Direct link to heading")
...
### Data Structures[​](#data-structures "Direct link to heading")
...
### Adding the Network[​](#adding-the-network "Direct link to heading")
...
### User Experience[​](#user-experience "Direct link to heading")
