---
title: Interact with a Solidity Smart Contract from a Golang Application
sidebarTitle: Interact from a Golang Application
---
...
How to Build[​](#how-to-build "Direct link to heading")
-------------------------------------------------------
