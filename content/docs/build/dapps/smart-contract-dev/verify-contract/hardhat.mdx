---
title: Verifying Smart Contracts Using Hardhat and Snowtrace
...
Flatten a Smart Contract using Hardhat[​](#flatten-a-smart-contract-using-hardhat "Direct link to heading")
-----------------------------------------------------------------------------------------------------------

To flatten the contract run the command: `npx hardhat flatten <path-to-contract> >> <flat-contract-name>.sol`

Clean up the flattened Smart Contract[​](#clean-up-the-flattened-smart-contract "Direct link to heading")
---------------------------------------------------------------------------------------------------------
...
Verify the Smart Contract using Snowtrace UI[​](#verify-the-smart-contract-using-snowtrace-ui "Direct link to heading")
-----------------------------------------------------------------------------------------------------------------------
...
Verify the Smart Contract Programmatically Using APIs[​](#verify-the-smart-contract-programmatically-using-apis "Direct link to heading")
-----------------------------------------------------------------------------------------------------------------------------------------
...
Verifying with Hardhat-Verify[​](#verifying-with-hardhat-verify "Direct link to heading")
-----------------------------------------------------------------------------------------
