---
title: Create an ERC-20 Token Using Solidity
sidebarTitle: Create an ERC-20 Token 
---
...
Set up Core[​](#set-up-core "Direct link to heading")
-----------------------------------------------------
...
Fund Your C-Chain Address[​](#fund-your-c-chain-address "Direct link to heading")
---------------------------------------------------------------------------------
...
Create Mintable Token[​](#create-mintable-token "Direct link to heading")
-------------------------------------------------------------------------
...
Interact with Token[​](#interact-with-token "Direct link to heading")
---------------------------------------------------------------------
...
Add Token to Core[​](#add-token-to-core "Direct link to heading")
-----------------------------------------------------------------
