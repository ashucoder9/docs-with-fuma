...
### NodeJS and Yarn[​](#nodejs-and-yarn "Direct link to heading")
...
### AvalancheGo and Avalanche Network Runner[​](#avalanchego-and-avalanche-network-runner "Direct link to heading")
...
### Solidity and Avalanche[​](#solidity-and-avalanche "Direct link to heading")
...
`git clone [[email protected]](https://docs.avax.network/cdn-cgi/l/email-protection):ava-labs/avalanche-smart-contract-quickstart.git`
...
Write Contracts[​](#write-contracts "Direct link to heading")
-------------------------------------------------------------
...
Hardhat Config[​](#hardhat-config "Direct link to heading")
-----------------------------------------------------------
...
Hardhat Tasks[​](#hardhat-tasks "Direct link to heading")
---------------------------------------------------------
...
### Balances[​](#balances "Direct link to heading")
...
### ERC20 Balances[​](#erc20-balances "Direct link to heading")
...
This will return the result in wei. If you want to know the exact amount of token with its token name then you need to divide it with its decimal. `erc20.abi.json` can be [found here](https://docs.avax.network/assets/files/erc20.abi-a562e36ad30a4d751911073568ea0546.json).
...
Hardhat Help[​](#hardhat-help "Direct link to heading")
-------------------------------------------------------

Run `yarn hardhat` to list Hardhat's version, usage instructions, global options and available tasks.

Typical Avalanche Network Runner Workflow[​](#typical-avalanche-network-runner-workflow "Direct link to heading")
-----------------------------------------------------------------------------------------------------------------

### Run Avalanche Network Runner[​](#run-avalanche-network-runner "Direct link to heading")
...
### Fund Accounts[​](#fund-accounts "Direct link to heading")
...
### Compile Smart Contracts[​](#compile-smart-contracts "Direct link to heading")
...
Deploy Smart Contracts[​](#deploy-smart-contracts "Direct link to heading")
---------------------------------------------------------------------------
...
### Interact with Smart Contract[​](#interact-with-smart-contract "Direct link to heading")
