---
title: Using Foundry with the Avalanche C-Chain
...
Recommended Knowledge[​](#recommended-knowledge "Direct link to heading")
-------------------------------------------------------------------------
...
[Avalanche Network Runner](/tooling/avalanche-network-runner/introduction) is a tool to quickly deploy local test networks. Together, you can deploy local test networks and run tests on them.
...
### Clone Avalanche Smart Contract Quick Start[​](#clone-avalanche-smart-contract-quick-start "Direct link to heading")
...
Compile, Deploy, and Verify with Forge[​](#compile-deploy-and-verify-with-forge "Direct link to heading")
---------------------------------------------------------------------------------------------------------
...
Verifying After Deployment[​](#verifying-after-deployment "Direct link to heading")
-----------------------------------------------------------------------------------
...
Using Cast to Interact with the Smart Contract[​](#using-cast-to-interact-with-the-smart-contract "Direct link to heading")
---------------------------------------------------------------------------------------------------------------------------
...
Local Workflow[​](#local-workflow "Direct link to heading")
-----------------------------------------------------------

The Fuji workflow above can be adapted to a Local Network by doing following:

In a new terminal navigate to your [Avalanche Network Runner](/tooling/avalanche-network-runner/introduction) directory.
