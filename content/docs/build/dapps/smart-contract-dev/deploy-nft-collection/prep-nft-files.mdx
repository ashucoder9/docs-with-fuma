---
title: Preparing NFT Files for an ERC721 Smart Contract
sidebarTitle: Prep NFT Files
---
...
NOTE: Some projects start file names with `0`, and others with `1`. That choice will need to be consistent with the smart contract code. To be consistent with [this ERC-721 tutorial](/build/dapps/smart-contract-dev/deploy-nft-collection/deploy-erc-721), we'll name this file `0`.
...
Now that the image and metadata files are ready, we can prepare to deploy a smart contract by following this [ERC-721 tutorial](/build/dapps/smart-contract-dev/deploy-nft-collection/deploy-erc-721).