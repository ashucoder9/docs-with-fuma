...
Manage the Subnet Binaries[​](#manage-the-subnet-binaries "Direct link to heading")
-----------------------------------------------------------------------------------

_After building AvalancheGo successfully,_

### 1\. Clone [Subnet-EVM](https://github.com/ava-labs/subnet-evm)[​](#1-clone-subnet-evm "Direct link to heading")
...
### 2\. Build the Binary and Save as a Plugin[​](#2-build-the-binary-and-save-as-a-plugin "Direct link to heading")
...
### 3\. Specify the Plugin with a Config.json[​](#3-specify-the-plugin-with-a-configjson "Direct link to heading")
...
Run the Node[​](#run-the-node "Direct link to heading")
-------------------------------------------------------
...
Bootstrapping and RPC Details[​](#bootstrapping-and-rpc-details "Direct link to heading")
-----------------------------------------------------------------------------------------
