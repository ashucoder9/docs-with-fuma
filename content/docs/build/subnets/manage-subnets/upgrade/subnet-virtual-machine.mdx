---
title: How to Upgrade a Subnet's Virtual Machine
sidebarTitle: Subnet Virtual Machine
...
<Callout type="info">
    If you are running multiple Subnets concurrently, you may need to update multiple Subnets to restart the network. All of your deployed must be using the same RPC Protocol version. You can see more details about this [here](/build/subnets/troubleshooting#incompatible-rpc-version-for-custom-vm).
</Callout>
