---
title: Enable Testnet Capabilities on a Subnet with Avalanche Subnet Faucet
sidebarTitle: Add a Testnet Faucet
---
...
### Rate Limiters (Important)[​](#rate-limiters-important "Direct link to heading")
