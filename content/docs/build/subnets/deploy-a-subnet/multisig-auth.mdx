---
title: Deploy a Subnet with Multisig Authorization
sidebarTitle: With Multisig Authorization
---
...
- Familiarity with process of [Deploying a Subnet on Testnet](/build/subnets/deploy-a-subnet/fuji-testnet) and [Deploying a Permissioned Subnet on Mainnet](/build/subnets/deploy-a-subnet/avalanche-mainnet)
- Multiple Ledger devices [configured for Avalanche](/build/subnets/deploy-a-subnet/avalanche-mainnet#setting-up-your-ledger)
...
When deploying a Subnet with Ledger's, you must include the Ledger's default address determined in [Specify Network](#specify-network) for the deployment to succeed. You may see an error like
...
Take a look at [Add a Validator](/build/subnets/deploy-a-subnet/avalanche-mainnet#add-a-validator) for additional help issuing this transaction.
