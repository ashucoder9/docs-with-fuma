---
title: Integrating Avalanche Warp Messaging into the EVM
...
How does Avalanche Warp Messaging Work?[​](#how-does-avalanche-warp-messaging-work "Direct link to heading")
------------------------------------------------------------------------------------------------------------
...
For more details on Avalanche Warp Messaging, see the AvalancheGo [Warp README](/build/cross-chain/avalanche-warp-messaging/deep-dive).

### Flow of Sending / Receiving a Warp Message within the EVM[​](#flow-of-sending--receiving-a-warp-message-within-the-evm "Direct link to heading")
...
### Warp Precompile[​](#warp-precompile "Direct link to heading")
...
#### sendWarpMessage[​](#sendwarpmessage "Direct link to heading")
...
#### getVerifiedMessage[​](#getverifiedmessage "Direct link to heading")
...
#### getBlockchainID[​](#getblockchainid "Direct link to heading")
...
The `blockchainID` in Avalanche refers to the txID that created the blockchain on the Avalanche P-Chain ([docs](/api-reference/p-chain/transaction-format#unsigned-create-chain-tx)).

### Predicate Encoding[​](#predicate-encoding "Direct link to heading")
...
### Performance Optimization: C-Chain to Subnet[​](#performance-optimization-c-chain-to-subnet "Direct link to heading")
...
Design Considerations[​](#design-considerations "Direct link to heading")
-------------------------------------------------------------------------

### Re-Processing Historical Blocks[​](#re-processing-historical-blocks "Direct link to heading")
...
### Guarantees Offered by Warp Precompile vs. Built on Top[​](#guarantees-offered-by-warp-precompile-vs-built-on-top "Direct link to heading")

#### Guarantees Offered by Warp Precompile[​](#guarantees-offered-by-warp-precompile "Direct link to heading")
...
#### Explicitly Not Provided / Built on Top[​](#explicitly-not-provided--built-on-top "Direct link to heading")
