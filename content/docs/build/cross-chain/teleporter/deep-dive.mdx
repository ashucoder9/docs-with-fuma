...
Deployed Addresses[​](#deployed-addresses "Direct link to heading")
-------------------------------------------------------------------
...
### Initialize the repository[​](#initialize-the-repository "Direct link to heading")
...
Run a local testnet in Docker[​](#run-a-local-testnet-in-docker "Direct link to heading")
-----------------------------------------------------------------------------------------
...
### Start up the local testnet[​](#start-up-the-local-testnet "Direct link to heading")
...
### Additional notes[​](#additional-notes "Direct link to heading")
...
### Run specific E2E tests[​](#run-specific-e2e-tests "Direct link to heading")
...
### Run the E2E tests on another network[​](#run-the-e2e-tests-on-another-network "Direct link to heading")
...
Deploy Teleporter to a Subnet[​](#deploy-teleporter-to-a-subnet "Direct link to heading")
-----------------------------------------------------------------------------------------
...
Deploy TeleporterRegistry to a Subnet[​](#deploy-teleporterregistry-to-a-subnet "Direct link to heading")
---------------------------------------------------------------------------------------------------------
...
ABI Bindings[​](#abi-bindings "Direct link to heading")
-------------------------------------------------------
