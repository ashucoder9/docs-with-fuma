...
sidebarTitle: Introduction to VMs
---

Overview[​](#overview "Direct link to heading")
-----------------------------------------------

A [Virtual Machine (VM)](/learn/virtual-machines) is a blueprint for a blockchain. Blockchains are instantiated from a VM, similar to how objects are instantiated from a class definition. VMs can define anything you want, but will generally define transactions that are executed and how blocks are created.

Blocks and State[​](#blocks-and-state "Direct link to heading")
---------------------------------------------------------------
...
In order to install a VM, its binary must be installed in the `AvalancheGo` plugin path. See [here](/nodes/configure/configs--flags#--plugin-dir-string) for more details. Multiple VMs can be installed in this location.
...
### API Handlers[​](#api-handlers "Direct link to heading")
...
### Instantiate a VM[​](#instantiate-a-vm "Direct link to heading")
...
### Initializing a VM to Create a Blockchain[​](#initializing-a-vm-to-create-a-blockchain "Direct link to heading")
...
### `block.ChainVM`[​](#blockchainvm "Direct link to heading")
...
```js /snow/engine/snowman/block/vm.go
...
### `common.VM`[​](#commonvm "Direct link to heading")
...
### `snowman.Block`[​](#snowmanblock "Direct link to heading")
...
```js /snow/consensus/snowman/block.go
...
### `choices.Decidable`[​](#choicesdecidable "Direct link to heading")
