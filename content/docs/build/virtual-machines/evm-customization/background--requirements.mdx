...
Precompile-EVM[​](#precompile-evm "Direct link to heading")
-----------------------------------------------------------
...
*   Install [Avalanche Network Runner](/tooling/avalanche-network-runner/introduction)
...
Complete Code[​](#complete-code "Direct link to heading")
---------------------------------------------------------
