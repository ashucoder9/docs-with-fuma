---
title:  Stateful Precompile Generation Tutorial
...
### Stateful Precompiled Contracts[​](#stateful-precompiled-contracts "Direct link to heading")
...
### AllowList[​](#allowlist "Direct link to heading")
...
You can find more information about the AllowList interface [here](/build/subnets/manage-subnets/upgrade/customize-subnet#allowlist-interface).