...
---
Adding Config Tests[​](#adding-config-tests "Direct link to heading")
---------------------------------------------------------------------
...
Adding Contract Tests[​](#adding-contract-tests "Direct link to heading")
-------------------------------------------------------------------------
...
Adding VM Tests (Optional)[​](#adding-vm-tests-optional "Direct link to heading")
---------------------------------------------------------------------------------
...
Adding DS-Test Case[​](#adding-ds-test-case "Direct link to heading")
---------------------------------------------------------------------
