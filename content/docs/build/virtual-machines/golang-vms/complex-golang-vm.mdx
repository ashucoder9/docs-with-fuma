---
title: How to Build a Complex Golang VM
sidebarTitle: Complex Golang VM
---
...
Lifecycle of a Transaction[​](#lifecycle-of-a-transaction "Direct link to heading")
-----------------------------------------------------------------------------------
...
Coding the Virtual Machine[​](#coding-the-virtual-machine "Direct link to heading")
-----------------------------------------------------------------------------------
...
### Transactions[​](#transactions "Direct link to heading")
...
#### UnsignedTransaction[​](#unsignedtransaction "Direct link to heading")
...
#### BaseTx[​](#basetx "Direct link to heading")
...
#### TransferTx[​](#transfertx "Direct link to heading")
...
#### SetTx[​](#settx "Direct link to heading")
...
### Mempool[​](#mempool "Direct link to heading")

#### Mempool Overview[​](#mempool-overview "Direct link to heading")
...
#### Mempool Methods[​](#mempool-methods "Direct link to heading")

#### Add[​](#add "Direct link to heading")
...
### Block Builder[​](#block-builder "Direct link to heading")

#### Block Builder Overview[​](#block-builder-overview "Direct link to heading")
...
#### Block Builder Methods[​](#block-builder-methods "Direct link to heading")

#### Gossip[​](#gossip "Direct link to heading")
...
#### Network Methods[​](#network-methods "Direct link to heading")

##### GossipNewTxs[​](#gossipnewtxs "Direct link to heading")
...
#### StatefulBlock[​](#statefulblock "Direct link to heading")
...
#### StatelessBlock[​](#statelessblock "Direct link to heading")
...
#### Virtual Machine Methods[​](#virtual-machine-methods "Direct link to heading")
...
##### BuildBlock[​](#buildblock "Direct link to heading")
...
##### LastAccepted[​](#lastaccepted "Direct link to heading")
...
### CLI[​](#cli "Direct link to heading")
...
#### Example 1[​](#example-1 "Direct link to heading")
...
#### Example 2[​](#example-2 "Direct link to heading")
