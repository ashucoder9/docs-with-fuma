---
title: Architecture of the TimestampVM
sidebarTitle: Defining the VM Itself
...
```rust avalanche-types/src/subnet/rpc/snowman/block.rs
...
```rust timestampvm/src/vm/mod.rs
