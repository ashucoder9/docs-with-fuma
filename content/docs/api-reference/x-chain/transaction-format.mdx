---
title: X-Chain Transaction Format
sidebarTitle: Transaction Format
---
This file is meant to be the single source of truth for how we serialize transactions in the Avalanche Virtual Machine (AVM). This document uses the [primitive serialization](/api-reference/standards/serialization) format for packing and [secp256k1](/api-reference/standards/cryptography#secp256k1-addresses) for cryptographic user identification.

Codec ID[​](#codec-id "Direct link to heading")
-----------------------------------------------
...
Transferable Output[​](#transferable-output "Direct link to heading")
---------------------------------------------------------------------

Transferable outputs wrap an output with an asset ID.

### What Transferable Output Contains[​](#what-transferable-output-contains "Direct link to heading")

A transferable output contains an `AssetID` and an [`Output`](/api-reference/x-chain/transaction-format#outputs).

- **`AssetID`** is a 32-byte array that defines which asset this output references.
- **`Output`** is an output, as defined [below](/api-reference/x-chain/transaction-format#outputs). Outputs have four possible types: [`SECP256K1TransferOutput`](/api-reference/x-chain/transaction-format#secp256k1-transfer-output), [`SECP256K1MintOutput`](/api-reference/x-chain/transaction-format#secp256k1-mint-output), [`NFTTransferOutput`](/api-reference/x-chain/transaction-format#nft-transfer-output) and [`NFTMintOutput`](/api-reference/x-chain/transaction-format#nft-mint-output).

### Gantt Transferable Output Specification[​](#gantt-transferable-output-specification "Direct link to heading")
...
### Proto Transferable Output Specification[​](#proto-transferable-output-specification "Direct link to heading")
...
### Transferable Output Example[​](#transferable-output-example "Direct link to heading")
...
Transferable Input[​](#transferable-input "Direct link to heading")
-------------------------------------------------------------------

Transferable inputs describe a specific UTXO with a provided transfer input.

### What Transferable Input Contains[​](#what-transferable-input-contains "Direct link to heading")
...
- **`Input`** is an input, as defined below. This can currently only be a [SECP256K1 transfer input](/api-reference/x-chain/transaction-format#secp256k1-transfer-input)

### Gantt Transferable Input Specification[​](#gantt-transferable-input-specification "Direct link to heading")
...
### Proto Transferable Input Specification[​](#proto-transferable-input-specification "Direct link to heading")
...
### Transferable Input Example[​](#transferable-input-example "Direct link to heading")
...
Transferable Op[​](#transferable-op "Direct link to heading")
-------------------------------------------------------------
...
### What Transferable Op Contains[​](#what-transferable-op-contains "Direct link to heading")
...
- **`TransferOp`** is a [transferable operation object](/api-reference/x-chain/transaction-format#operations).

### Gantt Transferable Op Specification[​](#gantt-transferable-op-specification "Direct link to heading")
...
### Proto Transferable Op Specification[​](#proto-transferable-op-specification "Direct link to heading")
...
### Transferable Op Example[​](#transferable-op-example "Direct link to heading")
...
Outputs have four possible types: [`SECP256K1TransferOutput`](/api-reference/x-chain/transaction-format#secp256k1-transfer-output), [`SECP256K1MintOutput`](/api-reference/x-chain/transaction-format#secp256k1-mint-output), [`NFTTransferOutput`](/api-reference/x-chain/transaction-format#nft-transfer-output) and [`NFTMintOutput`](/api-reference/x-chain/transaction-format#nft-mint-output).

SECP256K1 Mint Output[​](#secp256k1-mint-output "Direct link to heading")
-------------------------------------------------------------------------

A [secp256k1](/api-reference/standards/cryptography#secp256k1-addresses) mint output is an output that is owned by a collection of addresses.

### What SECP256K1 Mint Output Contains[​](#what-secp256k1-mint-output-contains "Direct link to heading")
...
### Gantt SECP256K1 Mint Output Specification[​](#gantt-secp256k1-mint-output-specification "Direct link to heading")
...
### Proto SECP256K1 Mint Output Specification[​](#proto-secp256k1-mint-output-specification "Direct link to heading")
...
### SECP256K1 Mint Output Example[​](#secp256k1-mint-output-example "Direct link to heading")
...
SECP256K1 Transfer Output[​](#secp256k1-transfer-output "Direct link to heading")
---------------------------------------------------------------------------------

A [secp256k1](/api-reference/standards/cryptography#secp256k1-addresses) transfer output allows for sending a quantity of an asset to a collection of addresses after a specified Unix time.

### What SECP256K1 Transfer Output Contains[​](#what-secp256k1-transfer-output-contains "Direct link to heading")
...
### Gantt SECP256K1 Transfer Output Specification[​](#gantt-secp256k1-transfer-output-specification "Direct link to heading")
...
### Proto SECP256K1 Transfer Output Specification[​](#proto-secp256k1-transfer-output-specification "Direct link to heading")
...
### SECP256K1 Transfer Output Example[​](#secp256k1-transfer-output-example "Direct link to heading")
...
NFT Mint Output[​](#nft-mint-output "Direct link to heading")
-------------------------------------------------------------

An NFT mint output is an NFT that is owned by a collection of addresses.

### What NFT Mint Output Contains[​](#what-nft-mint-output-contains "Direct link to heading")
...
### Gantt NFT Mint Output Specification[​](#gantt-nft-mint-output-specification "Direct link to heading")
...
### Proto NFT Mint Output Specification[​](#proto-nft-mint-output-specification "Direct link to heading")
...
### NFT Mint Output Example[​](#nft-mint-output-example "Direct link to heading")
...
NFT Transfer Output[​](#nft-transfer-output "Direct link to heading")
---------------------------------------------------------------------

An NFT transfer output is an NFT that is owned by a collection of addresses.

### What NFT Transfer Output Contains[​](#what-nft-transfer-output-contains "Direct link to heading")
...
### Gantt NFT Transfer Output Specification[​](#gantt-nft-transfer-output-specification "Direct link to heading")
...
### Proto NFT Transfer Output Specification[​](#proto-nft-transfer-output-specification "Direct link to heading")
...
### NFT Transfer Output Example[​](#nft-transfer-output-example "Direct link to heading")
...
Inputs[​](#inputs "Direct link to heading")
-------------------------------------------

Inputs have one possible type: `SECP256K1TransferInput`.

SECP256K1 Transfer Input[​](#secp256k1-transfer-input "Direct link to heading")
-------------------------------------------------------------------------------

A [secp256k1](/api-reference/standards/cryptography#secp256k1-addresses) transfer input allows for spending an unspent secp256k1 transfer output.

### What SECP256K1 Transfer Input Contains[​](#what-secp256k1-transfer-input-contains "Direct link to heading")
...
### Gantt SECP256K1 Transfer Input Specification[​](#gantt-secp256k1-transfer-input-specification "Direct link to heading")
...
### Proto SECP256K1 Transfer Input Specification[​](#proto-secp256k1-transfer-input-specification "Direct link to heading")
...
### SECP256K1 Transfer Input Example[​](#secp256k1-transfer-input-example "Direct link to heading")
...
Operations[​](#operations "Direct link to heading")
---------------------------------------------------

Operations have three possible types: `SECP256K1MintOperation`, `NFTMintOp`, and `NFTTransferOp`.

SECP256K1 Mint Operation[​](#secp256k1-mint-operation "Direct link to heading")
-------------------------------------------------------------------------------

A [secp256k1](/api-reference/standards/cryptography#secp256k1-addresses) mint operation consumes a SECP256K1 mint output, creates a new mint output and sends a transfer output to a new set of owners.

### What SECP256K1 Mint Operation Contains[​](#what-secp256k1-mint-operation-contains "Direct link to heading")
...
- **`AddressIndices`** is a list of unique ints that define the private keys that are being used to spend the [UTXO](/api-reference/x-chain/transaction-format#utxo). Each UTXO has an array of addresses that can spend the UTXO. Each int represents the index in this address array that will sign this transaction. The array must be sorted low to high.
- **`MintOutput`** is a [SECP256K1 Mint output](/api-reference/x-chain/transaction-format#secp256k1-mint-output).
- **`TransferOutput`** is a [SECP256K1 Transfer output](/api-reference/x-chain/transaction-format#secp256k1-transfer-output).

### Gantt SECP256K1 Mint Operation Specification[​](#gantt-secp256k1-mint-operation-specification "Direct link to heading")
...
### Proto SECP256K1 Mint Operation Specification[​](#proto-secp256k1-mint-operation-specification "Direct link to heading")
...
### SECP256K1 Mint Operation Example[​](#secp256k1-mint-operation-example "Direct link to heading")

Let's make a [secp256k1](/api-reference/standards/cryptography#secp256k1-addresses) mint operation with:
...
NFT Mint Op[​](#nft-mint-op "Direct link to heading")
-----------------------------------------------------

An NFT mint operation consumes an NFT mint output and sends an unspent output to a new set of owners.

### What NFT Mint Op Contains[​](#what-nft-mint-op-contains "Direct link to heading")
...
### Gantt NFT Mint Op Specification[​](#gantt-nft-mint-op-specification "Direct link to heading")
...
### Proto NFT Mint Op Specification[​](#proto-nft-mint-op-specification "Direct link to heading")
...
### NFT Mint Op Example[​](#nft-mint-op-example "Direct link to heading")
...
NFT Transfer Op[​](#nft-transfer-op "Direct link to heading")
-------------------------------------------------------------

An NFT transfer operation sends an unspent NFT transfer output to a new set of owners.

### What NFT Transfer Op Contains[​](#what-nft-transfer-op-contains "Direct link to heading")
...
- **`AddressIndices`** is a list of unique ints that define the private keys that are being used to spend the UTXO. Each UTXO has an array of addresses that can spend the UTXO. Each int represents the index in this address array that will sign this transaction. The array must be sorted low to high.
- **`NFTTransferOutput`** is the output of this operation and must be an [NFT Transfer Output](/api-reference/x-chain/transaction-format#nft-transfer-output). This output doesn't have the **`TypeId`**, because the type is known by the context of being in this operation.

### Gantt NFT Transfer Op Specification[​](#gantt-nft-transfer-op-specification "Direct link to heading")
...
### Proto NFT Transfer Op Specification[​](#proto-nft-transfer-op-specification "Direct link to heading")
...
### NFT Transfer Op Example[​](#nft-transfer-op-example "Direct link to heading")
...
Initial State[​](#initial-state "Direct link to heading")
---------------------------------------------------------
...
### What Initial State Contains[​](#what-initial-state-contains "Direct link to heading")
...
- **`Outputs`** is a variable length array of [outputs](/api-reference/x-chain/transaction-format#outputs), as defined above.

### Gantt Initial State Specification[​](#gantt-initial-state-specification "Direct link to heading")
...
### Proto Initial State Specification[​](#proto-initial-state-specification "Direct link to heading")
...
### Initial State Example[​](#initial-state-example "Direct link to heading")
...
SECP256K1 Credential[​](#secp256k1-credential "Direct link to heading")
-----------------------------------------------------------------------

A [secp256k1](/api-reference/standards/cryptography#secp256k1-addresses) credential contains a list of 65-byte recoverable signatures.

### What SECP256K1 Credential Contains[​](#what-secp256k1-credential-contains "Direct link to heading")
...
### Gantt SECP256K1 Credential Specification[​](#gantt-secp256k1-credential-specification "Direct link to heading")
...
### Proto SECP256K1 Credential Specification[​](#proto-secp256k1-credential-specification "Direct link to heading")
...
### SECP256K1 Credential Example[​](#secp256k1-credential-example "Direct link to heading")
...
NFT Credential[​](#nft-credential "Direct link to heading")
-----------------------------------------------------------

An NFT credential is the same as an [secp256k1 credential](/api-reference/x-chain/transaction-format#secp256k1-credential) with a different TypeID. The TypeID for an NFT credential is `0x0000000e`.

Unsigned Transactions[​](#unsigned-transactions "Direct link to heading")
-------------------------------------------------------------------------

Unsigned transactions contain the full content of a transaction with only the signatures missing. Unsigned transactions have four possible types: [`CreateAssetTx`](/api-reference/x-chain/transaction-format#what-unsigned-create-asset-tx-contains), [`OperationTx`](/api-reference/x-chain/transaction-format#what-unsigned-operation-tx-contains), [`ImportTx`](/api-reference/x-chain/transaction-format#what-unsigned-import-tx-contains), and [`ExportTx`](/api-reference/x-chain/transaction-format#what-unsigned-export-tx-contains). They all embed [`BaseTx`](/api-reference/x-chain/transaction-format#what-base-tx-contains), which contains common fields and operations.

Unsigned BaseTx[​](#unsigned-basetx "Direct link to heading")
-------------------------------------------------------------

### What Base TX Contains[​](#what-base-tx-contains "Direct link to heading")
...
### Proto Base TX Specification[​](#proto-base-tx-specification "Direct link to heading")
...
### Base TX Example[​](#base-tx-example "Direct link to heading")
...
Unsigned CreateAssetTx[​](#unsigned-createassettx "Direct link to heading")
---------------------------------------------------------------------------

### What Unsigned Create Asset TX Contains[​](#what-unsigned-create-asset-tx-contains "Direct link to heading")
...
- **`InitialStates`** is a variable length array that defines the feature extensions this asset supports, and the [initial state](/api-reference/x-chain/transaction-format#initial-state) of those feature extensions.

### Gantt Unsigned Create Asset TX Specification[​](#gantt-unsigned-create-asset-tx-specification "Direct link to heading")
...
### Proto Unsigned Create Asset TX Specification[​](#proto-unsigned-create-asset-tx-specification "Direct link to heading")
...
### Unsigned Create Asset TX Example[​](#unsigned-create-asset-tx-example "Direct link to heading")
...
Unsigned OperationTx[​](#unsigned-operationtx "Direct link to heading")
-----------------------------------------------------------------------

### What Unsigned Operation TX Contains[​](#what-unsigned-operation-tx-contains "Direct link to heading")

An unsigned operation TX contains a `BaseTx`, and `Ops`. The `TypeID` for this type is `0x00000002`.

- **`BaseTx`**
- **`Ops`** is a variable-length array of [Transferable Ops](/api-reference/x-chain/transaction-format#transferable-op).

### Gantt Unsigned Operation TX Specification[​](#gantt-unsigned-operation-tx-specification "Direct link to heading")
...
### Proto Unsigned Operation TX Specification[​](#proto-unsigned-operation-tx-specification "Direct link to heading")
...
### Unsigned Operation TX Example[​](#unsigned-operation-tx-example "Direct link to heading")
...
Unsigned ImportTx[​](#unsigned-importtx "Direct link to heading")
-----------------------------------------------------------------

### What Unsigned Import TX Contains[​](#what-unsigned-import-tx-contains "Direct link to heading")
...
- **`Ins`** is a variable length array of [Transferable Inputs](/api-reference/x-chain/transaction-format#transferable-input).

### Gantt Unsigned Import TX Specification[​](#gantt-unsigned-import-tx-specification "Direct link to heading")
...
### Proto Unsigned Import TX Specification[​](#proto-unsigned-import-tx-specification "Direct link to heading")
...
### Unsigned Import TX Example[​](#unsigned-import-tx-example "Direct link to heading")
...
Unsigned ExportTx[​](#unsigned-exporttx "Direct link to heading")
-----------------------------------------------------------------

### What Unsigned Export TX Contains[​](#what-unsigned-export-tx-contains "Direct link to heading")
...
- **`Outs`** is a variable length array of [Transferable Outputs](/api-reference/x-chain/transaction-format#transferable-output).

### Gantt Unsigned Export TX Specification[​](#gantt-unsigned-export-tx-specification "Direct link to heading")
...
### Proto Unsigned Export TX Specification[​](#proto-unsigned-export-tx-specification "Direct link to heading")
...
### Unsigned Export TX Example[​](#unsigned-export-tx-example "Direct link to heading")
...
Signed Transaction[​](#signed-transaction "Direct link to heading")
-------------------------------------------------------------------

A signed transaction is an unsigned transaction with the addition of an array of [credentials](/api-reference/x-chain/transaction-format#credentials).

### What Signed Transaction Contains[​](#what-signed-transaction-contains "Direct link to heading")
...
- **`Credentials`** is an array of [credentials](/api-reference/x-chain/transaction-format#credentials). Each credential will be paired with the input in the same index at this credential.

### Gantt Signed Transaction Specification[​](#gantt-signed-transaction-specification "Direct link to heading")
...
### Proto Signed Transaction Specification[​](#proto-signed-transaction-specification "Direct link to heading")
...
### Signed Transaction Example[​](#signed-transaction-example "Direct link to heading")
...
UTXO[​](#utxo "Direct link to heading")
---------------------------------------

A UTXO is a standalone representation of a transaction output.

### What UTXO Contains[​](#what-utxo-contains "Direct link to heading")
...
- **`Output`** is the output object that created this UTXO. The serialization of Outputs was defined above. Valid output types are [SECP Mint Output](/api-reference/x-chain/transaction-format#secp256k1-mint-output), [SECP Transfer Output](/api-reference/x-chain/transaction-format#secp256k1-transfer-output), [NFT Mint Output](/api-reference/x-chain/transaction-format#nft-mint-output), [NFT Transfer Output](/api-reference/x-chain/transaction-format#nft-transfer-output).

### Gantt UTXO Specification[​](#gantt-utxo-specification "Direct link to heading")
...
### Proto UTXO Specification[​](#proto-utxo-specification "Direct link to heading")
...
### UTXO Examples[​](#utxo-examples "Direct link to heading")
...
GenesisAsset[​](#genesisasset "Direct link to heading")
-------------------------------------------------------

An asset to be issued in an instance of the AVM's Genesis

### What GenesisAsset Contains[​](#what-genesisasset-contains "Direct link to heading")
...
### Gantt GenesisAsset Specification[​](#gantt-genesisasset-specification "Direct link to heading")
...
### GenesisAsset Example[​](#genesisasset-example "Direct link to heading")
