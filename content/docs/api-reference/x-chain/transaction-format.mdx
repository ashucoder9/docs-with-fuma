...
[primitive serialization](/docs/api-reference//standards/serialization) format for packing and
[secp256k1](/docs/api-reference//standards/cryptography#secp256k1-addresses) for cryptographic
user identification.
...
A transferable output contains an `AssetID` and an [`Output`](/docs/api-reference//avalanchego/x-chain/txn-format.md#outputs).

- **`AssetID`** is a 32-byte array that defines which asset this output references.
- **`Output`** is an output, as defined
  [below](/docs/api-reference//avalanchego/x-chain/txn-format.md#outputs). Outputs have four possible types:
  [`SECP256K1TransferOutput`](/docs/api-reference//avalanchego/x-chain/txn-format.md#secp256k1-transfer-output),
  [`SECP256K1MintOutput`](/docs/api-reference//avalanchego/x-chain/txn-format.md#secp256k1-mint-output),
  [`NFTTransferOutput`](/docs/api-reference//avalanchego/x-chain/txn-format.md#nft-transfer-output)
  and [`NFTMintOutput`](/docs/api-reference//avalanchego/x-chain/txn-format.md#nft-mint-output).
...
- **`Input`** is an input, as defined below. This can currently only be a [SECP256K1 transfer input](/docs/api-reference//avalanchego/x-chain/txn-format.md#secp256k1-transfer-input)
...
- **`TransferOp`** is a [transferable operation object](/docs/api-reference//avalanchego/x-chain/txn-format.md#operations).
...
[`SECP256K1TransferOutput`](/docs/api-reference//avalanchego/x-chain/txn-format.md#secp256k1-transfer-output),
[`SECP256K1MintOutput`](/docs/api-reference//avalanchego/x-chain/txn-format.md#secp256k1-mint-output),
[`NFTTransferOutput`](/docs/api-reference//avalanchego/x-chain/txn-format.md#nft-transfer-output) and
[`NFTMintOutput`](/docs/api-reference//avalanchego/x-chain/txn-format.md#nft-mint-output).

## SECP256K1 Mint Output

A [secp256k1](/docs/api-reference//standards/cryptography#secp256k1-addresses) mint output is
...
A [secp256k1](/docs/api-reference//standards/cryptography#secp256k1-addresses) transfer output
...
A [secp256k1](/docs/api-reference//standards/cryptography#secp256k1-addresses) transfer input
...
A [secp256k1](/docs/api-reference//standards/cryptography#secp256k1-addresses) mint operation
...
- **`AddressIndices`** is a list of unique ints that define the private keys
  ...
  [UTXO](/docs/api-reference//avalanchego/x-chain/txn-format.md#utxo). Each UTXO has an array of
  ...
  high.
- **`MintOutput`** is a [SECP256K1 Mint output](/docs/api-reference//avalanchego/x-chain/txn-format.md#secp256k1-mint-output).
- **`TransferOutput`** is a [SECP256K1 Transfer output](/docs/api-reference//avalanchego/x-chain/txn-format.md#secp256k1-transfer-output).
...
Let's make a [secp256k1](/docs/api-reference//standards/cryptography#secp256k1-addresses) mint
operation with:
...
- **`AddressIndices`** is a list of unique ints that define the private keys
  ...
  that can spend the UTXO. Each int represents the index in this address array
  that will sign this transaction. The array must be sorted low to high.
- **`NFTTransferOutput`** is the output of this operation and must be an [NFT Transfer Output](/docs/api-reference//avalanchego/x-chain/txn-format.md#nft-transfer-output). This
...
- **`Outputs`** is a variable length array of
  [outputs](/docs/api-reference//avalanchego/x-chain/txn-format.md#outputs), as defined above.
...
A [secp256k1](/docs/api-reference//standards/cryptography#secp256k1-addresses) credential
...
An NFT credential is the same as an [secp256k1 credential](/docs/api-reference//avalanchego/x-chain/txn-format.md#secp256k1-credential) with a
...
[`CreateAssetTx`](/docs/api-reference//avalanchego/x-chain/txn-format.md#what-unsigned-create-asset-tx-contains),
[`OperationTx`](/docs/api-reference//avalanchego/x-chain/txn-format.md#what-unsigned-operation-tx-contains),
[`ImportTx`](/docs/api-reference//avalanchego/x-chain/txn-format.md#what-unsigned-import-tx-contains),
and
[`ExportTx`](/docs/api-reference//avalanchego/x-chain/txn-format.md#what-unsigned-export-tx-contains).
They all embed
[`BaseTx`](/docs/api-reference//avalanchego/x-chain/txn-format.md#what-base-tx-contains), which
...
- **`Outputs`** is an array of [transferable output objects](/docs/api-reference//avalanchego/x-chain/txn-format.md#transferable-output). Outputs must
  ...
  fee.
- **`Inputs`** is an array of [transferable input objects](/docs/api-reference//avalanchego/x-chain/txn-format.md#transferable-input). Inputs must be
...
- **`InitialStates`** is a variable length array that defines the feature
  extensions this asset supports, and the [initial state](/docs/api-reference//avalanchego/x-chain/txn-format.md#initial-state) of those feature
  extensions.
...
- **`BaseTx`**
- **`Ops`** is a variable-length array of [Transferable Ops](/docs/api-reference//avalanchego/x-chain/txn-format.md#transferable-op).
...
- **`Ins`** is a variable length array of [Transferable Inputs](/docs/api-reference//avalanchego/x-chain/txn-format.md#transferable-input).
...
- **`Outs`** is a variable length array of [Transferable Outputs](/docs/api-reference//avalanchego/x-chain/txn-format.md#transferable-output).
...
A signed transaction is an unsigned transaction with the addition of an array of [credentials](/docs/api-reference//avalanchego/x-chain/txn-format.md#credentials).
...
- **`Credentials`** is an array of
  [credentials](/docs/api-reference//avalanchego/x-chain/txn-format.md#credentials). Each credential
...
- **`Output`** is the output object that created this UTXO. The serialization of
  Outputs was defined above. Valid output types are [SECP Mint Output](/docs/api-reference//avalanchego/x-chain/txn-format.md#secp256k1-mint-output), [SECP Transfer Output](/docs/api-reference//avalanchego/x-chain/txn-format.md#secp256k1-transfer-output),
  [NFT Mint Output](/docs/api-reference//avalanchego/x-chain/txn-format.md#nft-mint-output), [NFT Transfer Output](/docs/api-reference//avalanchego/x-chain/txn-format.md#nft-transfer-output).
