...
or `P-Chain`. This document uses the [primitive serialization](/docs/api-reference//standards/serialization) format for packing and
...
A [secp256k1](/docs/api-reference//standards/cryptography#secp256k1-addresses) output owners
