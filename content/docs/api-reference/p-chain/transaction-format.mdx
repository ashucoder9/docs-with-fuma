---
title: P-Chain Transaction Format
sidebarTitle: Transaction Format
---
This file is meant to be the single source of truth for how we serialize transactions in Avalanche's Platform Virtual Machine, aka the `Platform Chain` or `P-Chain`. This document uses the [primitive serialization](/api-reference/standards/serialization) format for packing and [secp256k1](/api-reference/standards/cryptography#secp256k1-addresses) for cryptographic user identification.
...
### What Proof of Possession Contains[​](#what-proof-of-possession-contains "Direct link to heading")
...
### Proof of Possession Specification[​](#proof-of-possession-specification "Direct link to heading")
...
### Proof of Possession Specification[​](#proof-of-possession-specification-1 "Direct link to heading")
...
### Proof of Possession Example[​](#proof-of-possession-example "Direct link to heading")
...
A [secp256k1](/api-reference/standards/cryptography#secp256k1-addresses) transfer output allows for sending a quantity of an asset to a collection of addresses after a specified Unix time. The only valid asset is AVAX.
...
SECP256K1 Output Owners Output[​](#secp256k1-output-owners-output "Direct link to heading")
-------------------------------------------------------------------------------------------

A [secp256k1](/api-reference/standards/cryptography#secp256k1-addresses) output owners output will receive the staking rewards when the lock up period ends.

### What SECP256K1 Output Owners Output Contains[​](#what-secp256k1-output-owners-output-contains "Direct link to heading")
...
### Gantt SECP256K1 Output Owners Output Specification[​](#gantt-secp256k1-output-owners-output-specification "Direct link to heading")
...
### Proto SECP256K1 Output Owners Output Specification[​](#proto-secp256k1-output-owners-output-specification "Direct link to heading")
...
### SECP256K1 Output Owners Output Example[​](#secp256k1-output-owners-output-example "Direct link to heading")
...
Unsigned Add Validator TX[​](#unsigned-add-validator-tx "Direct link to heading")
---------------------------------------------------------------------------------

### What Unsigned Add Validator TX Contains[​](#what-unsigned-add-validator-tx-contains "Direct link to heading")
...
### Gantt Unsigned Add Validator TX Specification[​](#gantt-unsigned-add-validator-tx-specification "Direct link to heading")
...
### Proto Unsigned Add Validator TX Specification[​](#proto-unsigned-add-validator-tx-specification "Direct link to heading")
...
### Unsigned Add Validator TX Example[​](#unsigned-add-validator-tx-example "Direct link to heading")
...
Unsigned Remove Subnet Validator TX[​](#unsigned-remove-subnet-validator-tx "Direct link to heading")
-----------------------------------------------------------------------------------------------------

### What Unsigned Remove Subnet Validator TX Contains[​](#what-unsigned-remove-subnet-validator-tx-contains "Direct link to heading")
...
### Gantt Unsigned Remove Subnet Validator TX Specification[​](#gantt-unsigned-remove-subnet-validator-tx-specification "Direct link to heading")
...
### Proto Unsigned Remove Subnet Validator TX Specification[​](#proto-unsigned-remove-subnet-validator-tx-specification "Direct link to heading")
...
### Unsigned Remove Subnet Validator TX Example[​](#unsigned-remove-subnet-validator-tx-example "Direct link to heading")
...
Unsigned Add Permissionless Validator TX[​](#unsigned-add-permissionless-validator-tx "Direct link to heading")
---------------------------------------------------------------------------------------------------------------

### What Unsigned Add Permissionless Validator TX Contains[​](#what-unsigned-add-permissionless-validator-tx-contains "Direct link to heading")
...
*   **`Signer`** If the \[SubnetID\] is the primary network, \[Signer\] is the type ID 28 (`0x1C`) followed by a [Proof of Possession](#proof-of-possession). If the \[SubnetID\] is not the primary network, this value is the empty signer, whose byte representation is only the type ID 27 (`0x1B`).
...
### Gantt Unsigned Add Permissionless Validator TX Specification[​](#gantt-unsigned-add-permissionless-validator-tx-specification "Direct link to heading")
...
### Proto Unsigned Add Permissionless Validator TX Specification[​](#proto-unsigned-add-permissionless-validator-tx-specification "Direct link to heading")
...
### Unsigned Add Permissionless Validator TX Example[​](#unsigned-add-permissionless-validator-tx-example "Direct link to heading")
...
Unsigned Add Permissionless Delegator TX[​](#unsigned-add-permissionless-delegator-tx "Direct link to heading")
---------------------------------------------------------------------------------------------------------------

### What Unsigned Add Permissionless Delegator TX Contains[​](#what-unsigned-add-permissionless-delegator-tx-contains "Direct link to heading")
...
### Gantt Unsigned Add Permissionless Delegator TX Specification[​](#gantt-unsigned-add-permissionless-delegator-tx-specification "Direct link to heading")
...
### Proto Unsigned Add Permissionless Delegator TX Specification[​](#proto-unsigned-add-permissionless-delegator-tx-specification "Direct link to heading")
...
### Unsigned Add Permissionless Delegator TX Example[​](#unsigned-add-permissionless-delegator-tx-example "Direct link to heading")
...
Unsigned Transform Subnet TX[​](#unsigned-transform-subnet-tx "Direct link to heading")
---------------------------------------------------------------------------------------

Transforms a permissioned Subnet into a permissionless Subnet. Must be signed by the Subnet owner.

### What Unsigned Transform Subnet TX Contains[​](#what-unsigned-transform-subnet-tx-contains "Direct link to heading")
...
### Gantt Unsigned Transform Subnet TX Specification[​](#gantt-unsigned-transform-subnet-tx-specification "Direct link to heading")
...
### Proto Unsigned Transform Subnet TX Specification[​](#proto-unsigned-transform-subnet-tx-specification "Direct link to heading")
...
### Unsigned Transform Subnet TX Example[​](#unsigned-transform-subnet-tx-example "Direct link to heading")
...
Unsigned Add Subnet Validator TX[​](#unsigned-add-subnet-validator-tx "Direct link to heading")
-----------------------------------------------------------------------------------------------

### What Unsigned Add Subnet Validator TX Contains[​](#what-unsigned-add-subnet-validator-tx-contains "Direct link to heading")
...
### Gantt Unsigned Add Subnet Validator TX Specification[​](#gantt-unsigned-add-subnet-validator-tx-specification "Direct link to heading")
...
### Proto Unsigned Add Subnet Validator TX Specification[​](#proto-unsigned-add-subnet-validator-tx-specification "Direct link to heading")
...
### Unsigned Add Subnet Validator TX Example[​](#unsigned-add-subnet-validator-tx-example "Direct link to heading")
...
Unsigned Add Delegator TX[​](#unsigned-add-delegator-tx "Direct link to heading")
---------------------------------------------------------------------------------

### What Unsigned Add Delegator TX Contains[​](#what-unsigned-add-delegator-tx-contains "Direct link to heading")
...
### Gantt Unsigned Add Delegator TX Specification[​](#gantt-unsigned-add-delegator-tx-specification "Direct link to heading")
...
### Proto Unsigned Add Delegator TX Specification[​](#proto-unsigned-add-delegator-tx-specification "Direct link to heading")
...
### Unsigned Add Delegator TX Example[​](#unsigned-add-delegator-tx-example "Direct link to heading")
...
Unsigned Create Chain TX[​](#unsigned-create-chain-tx "Direct link to heading")
-------------------------------------------------------------------------------

### What Unsigned Create Chain TX Contains[​](#what-unsigned-create-chain-tx-contains "Direct link to heading")
...
### Gantt Unsigned Create Chain TX Specification[​](#gantt-unsigned-create-chain-tx-specification "Direct link to heading")
...
### Proto Unsigned Create Chain TX Specification[​](#proto-unsigned-create-chain-tx-specification "Direct link to heading")
...
### Unsigned Create Chain TX Example[​](#unsigned-create-chain-tx-example "Direct link to heading")
...
Unsigned Create Subnet TX[​](#unsigned-create-subnet-tx "Direct link to heading")
---------------------------------------------------------------------------------

### What Unsigned Create Subnet TX Contains[​](#what-unsigned-create-subnet-tx-contains "Direct link to heading")
...
### Gantt Unsigned Create Subnet TX Specification[​](#gantt-unsigned-create-subnet-tx-specification "Direct link to heading")
...
### Proto Unsigned Create Subnet TX Specification[​](#proto-unsigned-create-subnet-tx-specification "Direct link to heading")
...
### Unsigned Create Subnet TX Example[​](#unsigned-create-subnet-tx-example "Direct link to heading")
...
Unsigned Import TX[​](#unsigned-import-tx "Direct link to heading")
-------------------------------------------------------------------
...
Unsigned Export TX[​](#unsigned-export-tx "Direct link to heading")
-------------------------------------------------------------------
...
### UTXO Example[​](#utxo-example "Direct link to heading")
...
StakeableLockIn[​](#stakeablelockin "Direct link to heading")
-------------------------------------------------------------
...
### What StakeableLockIn Contains[​](#what-stakeablelockin-contains "Direct link to heading")
...
### Gantt StakeableLockIn Specification[​](#gantt-stakeablelockin-specification "Direct link to heading")
...
### Proto StakeableLockIn Specification[​](#proto-stakeablelockin-specification "Direct link to heading")
...
### StakeableLockIn Example[​](#stakeablelockin-example "Direct link to heading")
...
StakeableLockOut[​](#stakeablelockout "Direct link to heading")
---------------------------------------------------------------

A StakeableLockOut is an output that is locked until its lock time, but can be staked in the meantime.

### What StakeableLockOut Contains[​](#what-stakeablelockout-contains "Direct link to heading")
...
### Gantt StakeableLockOut Specification[​](#gantt-stakeablelockout-specification "Direct link to heading")
...
### Proto StakeableLockOut Specification[​](#proto-stakeablelockout-specification "Direct link to heading")
...
### StakeableLockOut Example[​](#stakeablelockout-example "Direct link to heading")
...
Subnet Auth[​](#subnet-auth "Direct link to heading")
-----------------------------------------------------

### What Subnet Auth Contains[​](#what-subnet-auth-contains "Direct link to heading")
...
### Gantt Subnet Auth Specification[​](#gantt-subnet-auth-specification "Direct link to heading")
...
### Proto Subnet Auth Specification[​](#proto-subnet-auth-specification "Direct link to heading")
...
### Subnet Auth Example[​](#subnet-auth-example "Direct link to heading")
...
### What Validator Contains[​](#what-validator-contains "Direct link to heading")
...
### Gantt Validator Specification[​](#gantt-validator-specification "Direct link to heading")
...
### Proto Validator Specification[​](#proto-validator-specification "Direct link to heading")
...
### Validator Example[​](#validator-example "Direct link to heading")
...
Rewards Owner[​](#rewards-owner "Direct link to heading")
---------------------------------------------------------

Where to send staking rewards when done validating

### What Rewards Owner Contains[​](#what-rewards-owner-contains "Direct link to heading")
...
### Gantt Rewards Owner Specification[​](#gantt-rewards-owner-specification "Direct link to heading")
...
### Proto Rewards Owner Specification[​](#proto-rewards-owner-specification "Direct link to heading")
...
### Rewards Owner Example[​](#rewards-owner-example "Direct link to heading")
