---
title: C-Chain Transaction Format
sidebarTitle: Transaction Format
---
This page is meant to be the single source of truth for how we serialize atomic transactions in `Coreth`. This document uses the [primitive serialization](/api-reference/standards/serialization) format for packing and [secp256k1](/api-reference/standards/cryptography#cryptography-in-the-avalanche-virtual-machine) for cryptographic user identification.
...
EVM Input[​](#evm-input "Direct link to heading")
-------------------------------------------------

Input type that specifies an EVM account to deduct the funds from as part of an `ExportTx`.

### What EVM Input Contains[​](#what-evm-input-contains "Direct link to heading")
...
### Gantt EVM Input Specification[​](#gantt-evm-input-specification "Direct link to heading")
...
### Proto EVM Input Specification[​](#proto-evm-input-specification "Direct link to heading")
...
### EVM Input Example[​](#evm-input-example "Direct link to heading")
...
A [secp256k1](/api-reference/standards/cryptography#cryptography-in-the-avalanche-virtual-machine) transfer input allows for spending an unspent secp256k1 transfer output.
...
EVM Output[​](#evm-output "Direct link to heading")
---------------------------------------------------

Output type specifying a state change to be applied to an EVM account as part of an `ImportTx`.

### What EVM Output Contains[​](#what-evm-output-contains "Direct link to heading")
...
### Gantt EVM Output Specification[​](#gantt-evm-output-specification "Direct link to heading")
...
### Proto EVM Output Specification[​](#proto-evm-output-specification "Direct link to heading")
...
### EVM Output Example[​](#evm-output-example "Direct link to heading")
...
A [secp256k1](/api-reference/standards/cryptography#cryptography-in-the-avalanche-virtual-machine) transfer output allows for sending a quantity of an asset to a collection of addresses after a specified Unix time.
...
### Gantt ExportTx Specification[​](#gantt-exporttx-specification "Direct link to heading")
...
### ExportTx Example[​](#exporttx-example "Direct link to heading")
...
ImportTx[​](#importtx "Direct link to heading")
-----------------------------------------------

ImportTx is a transaction to import funds to Coreth from another chain.

### What ImportTx Contains[​](#what-importtx-contains "Direct link to heading")
...
### Gantt ImportTx Specification[​](#gantt-importtx-specification "Direct link to heading")
...
### ImportTx Example[​](#importtx-example "Direct link to heading")
...
A [secp256k1](/api-reference/standards/cryptography#cryptography-in-the-avalanche-virtual-machine) credential contains a list of 65-byte recoverable signatures.
