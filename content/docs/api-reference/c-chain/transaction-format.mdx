...
transactions in `Coreth`. This document uses the [primitive serialization](/docs/api-reference//standards/serialization) format for packing and
[secp256k1](/docs/api-reference//standards/cryptography#cryptography-in-the-avalanche-virtual-machine)
