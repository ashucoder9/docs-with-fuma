...
### `state-sync-enabled`[​](#state-sync-enabled "Direct link to heading")
...
### `state-sync-skip-resume`[​](#state-sync-skip-resume "Direct link to heading")
...
### `state-sync-min-blocks`[​](#state-sync-min-blocks "Direct link to heading")
...
### `state-sync-ids`[​](#state-sync-ids "Direct link to heading")
...
### `state-sync-server-trie-cache`[​](#state-sync-server-trie-cache "Direct link to heading")
...
### `continuous-profiler-dir`[​](#continuous-profiler-dir "Direct link to heading")
...
### `continuous-profiler-frequency`[​](#continuous-profiler-frequency "Direct link to heading")

_Duration_

Specifies the frequency to run the continuous profiler. Defaults `900000000000` nano seconds which is 15 minutes.

### `continuous-profiler-max-files`[​](#continuous-profiler-max-files "Direct link to heading")

_Integer_

Specifies the maximum number of profiles to keep before removing the oldest. Defaults to `5`.

Enabling Avalanche Specific APIs[​](#enabling-avalanche-specific-apis "Direct link to heading")
-----------------------------------------------------------------------------------------------

### `snowman-api-enabled`[​](#snowman-api-enabled "Direct link to heading")

_Boolean_

Enables the Snowman API. Defaults to `false`.

### `coreth-admin-api-enabled`[​](#coreth-admin-api-enabled "Direct link to heading")
...
### `coreth-admin-api-dir`[​](#coreth-admin-api-dir "Direct link to heading")
...
### Enabling EVM APIs[​](#enabling-evm-apis "Direct link to heading")

### `eth-apis` (\[\]string)[​](#eth-apis-string "Direct link to heading")
...
### `eth`[​](#eth "Direct link to heading")
...
### `eth-filter`[​](#eth-filter "Direct link to heading")
...
### `net`[​](#net "Direct link to heading")
...
### `debug-tracer`[​](#debug-tracer "Direct link to heading")
...
### `web3`[​](#web3 "Direct link to heading")
...
### `internal-eth`[​](#internal-eth "Direct link to heading")
...
### `internal-blockchain`[​](#internal-blockchain "Direct link to heading")
...
### `internal-transaction`[​](#internal-transaction "Direct link to heading")
...
### `internal-tx-pool`[​](#internal-tx-pool "Direct link to heading")
...
### `internal-debug`[​](#internal-debug "Direct link to heading")
...
### `debug-handler`[​](#debug-handler "Direct link to heading")
...
### `internal-account`[​](#internal-account "Direct link to heading")
...
### `internal-personal`[​](#internal-personal "Direct link to heading")
...
Transaction Pool[​](#transaction-pool "Direct link to heading")
---------------------------------------------------------------

### `local-txs-enabled`[​](#local-txs-enabled "Direct link to heading")

_Boolean_

Enables local transaction handling (prioritizes transactions submitted through this node). Defaults to `false`.

### `allow-unprotected-txs`[​](#allow-unprotected-txs "Direct link to heading")
...
### `allow-unprotected-tx-hashes`[​](#allow-unprotected-tx-hashes "Direct link to heading")
...
### `pull-gossip-frequency`[​](#pull-gossip-frequency "Direct link to heading")

_Duration_

Frequency to request transactions from peers. Defaults to `1000000000` nano seconds which is 1 second.

### `tx-regossip-frequency`[​](#tx-regossip-frequency "Direct link to heading")
...
### `metrics-enabled`[​](#metrics-enabled "Direct link to heading")

_Boolean_

Enables metrics. Defaults to `false`.

### `metrics-expensive-enabled`[​](#metrics-expensive-enabled "Direct link to heading")

_Boolean_

Enables expensive metrics. Defaults to `false`.

Snapshots[​](#snapshots "Direct link to heading")
-------------------------------------------------

### `snapshot-async`[​](#snapshot-async "Direct link to heading")

_Boolean_

If `true`, allows snapshot generation to be executed asynchronously. Defaults to `true`.

### `snapshot-verification-enabled`[​](#snapshot-verification-enabled "Direct link to heading")
...
### `log-json-format`[​](#log-json-format "Direct link to heading")

_Boolean_

If `true`, changes logs to JSON format. Defaults to `false`.

### Keystore Settings[​](#keystore-settings "Direct link to heading")

### `keystore-directory`[​](#keystore-directory "Direct link to heading")
...
### `keystore-external-signer`[​](#keystore-external-signer "Direct link to heading")

_String_

Specifies an external URI for a clef-type signer. Defaults to the empty string (`""` as not enabled).

### `keystore-insecure-unlock-allowed`[​](#keystore-insecure-unlock-allowed "Direct link to heading")
...
### `trie-clean-cache`[​](#trie-clean-cache "Direct link to heading")

_Integer_

Size of cache used for clean trie nodes (in MBs). Should be a multiple of `64`. Defaults to `512`.

### `trie-dirty-cache`[​](#trie-dirty-cache "Direct link to heading")
...
### `trie-clean-rejournal`[​](#trie-clean-rejournal "Direct link to heading")
...
### `populate-missing-tries`[​](#populate-missing-tries "Direct link to heading")
...
### `offline-pruning-bloom-filter-size`[​](#offline-pruning-bloom-filter-size "Direct link to heading")
...
### `offline-pruning-data-directory`[​](#offline-pruning-data-directory "Direct link to heading")
...
### `tx-lookup-limit` (uint64)[​](#tx-lookup-limit-uint64 "Direct link to heading")
...
### `skip-tx-indexing`[​](#skip-tx-indexing "Direct link to heading")
...
VM Networking[​](#vm-networking "Direct link to heading")
---------------------------------------------------------

### `max-outbound-active-requests`[​](#max-outbound-active-requests "Direct link to heading")

_Integer_

Specifies the maximum number of outbound VM2VM requests in flight at once. Defaults to `16`.

### `max-outbound-active-cross-chain-requests`[​](#max-outbound-active-cross-chain-requests "Direct link to heading")
...
### `skip-upgrade-check`[​](#skip-upgrade-check "Direct link to heading")
