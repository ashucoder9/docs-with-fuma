...
Ethereum APIs[​](#ethereum-apis "Direct link to heading")
---------------------------------------------------------

### Endpoints[​](#endpoints "Direct link to heading")

#### JSON-RPC Endpoints[​](#json-rpc-endpoints "Direct link to heading")
...
#### WebSocket Endpoints[​](#websocket-endpoints "Direct link to heading")


<Callout title="Note">
On the [public API node](/tooling/rpc-providers#supported-apis), it only supports C-Chain websocket API calls for API methods that don't exist on the C-Chain's HTTP API
</Callout>
...
On localhost, use `ws://`. When using the [Public API](/tooling/rpc-providers) or another host that supports encryption, use `wss://`.
</Callout>
...
### Standard Ethereum APIs[​](#standard-ethereum-apis "Direct link to heading")
...
You can interact with these services the same exact way you'd interact with Geth. See the [Ethereum Wiki's JSON-RPC Documentation](https://ethereum.org/en/developers/docs/apis/json-rpc/) and [Geth's JSON-RPC Documentation](https://geth.ethereum.org/docs/rpc/server) for a full description of this API.


<Callout title="Note">
For batched requests on the [public API node](/tooling/rpc-providers) , the maximum number of items is 40. We are working on to support a larger batch size.
</Callout>

### Avalanche - Ethereum APIs[​](#avalanche---ethereum-apis "Direct link to heading")
...
#### `eth_getAssetBalance`[​](#eth_getassetbalance "Direct link to heading")
...
#### `eth_baseFee`[​](#eth_basefee "Direct link to heading")
...
#### `eth_maxPriorityFeePerGas`[​](#eth_maxpriorityfeepergas "Direct link to heading")
...
For more information on dynamic fees see the [C-Chain section of the transaction fee documentation](/api-reference/standards/guides/transaction-fees#c-chain-fees).

#### `eth_getChainConfig`[​](#eth_getchainconfig "Direct link to heading")
...
Avalanche Specific APIs[​](#avalanche-specific-apis "Direct link to heading")
-----------------------------------------------------------------------------
...
### `avax.export`[​](#avaxexport "Direct link to heading")
...
\Export an asset from the C-Chain to X-Chain or P-Chain. If exporting to the X-Chain, you must call the X-Chain's [`avm.import`](/api-reference/x-chain/api#avmimport).
...
### `avax.exportAVAX`[​](#avaxexportavax "Direct link to heading")
...
Send AVAX from the C-Chain to X-Chain or P-Chain. If exporting to the X-Chain, you must call the X-Chain's [`avm.import`](/api-reference/x-chain/api#avmimport) with assetID `AVAX` on the X-Chain to complete the transfer.
...
### `avax.exportKey`[​](#avaxexportkey "Direct link to heading")
...
### `avax.getAtomicTxStatus`[​](#avaxgetatomictxstatus "Direct link to heading")
...
### `avax.getUTXOs`[​](#avaxgetutxos "Direct link to heading")
...
### `avax.import`[​](#avaximport "Direct link to heading")
...
### `avax.importAVAX`[​](#avaximportavax "Direct link to heading")
...
### `avax.importKey`[​](#avaximportkey "Direct link to heading")
...
### `avax.issueTx`[​](#avaxissuetx "Direct link to heading")
...
Admin API[​](#admin-api "Direct link to heading")
-------------------------------------------------

This API can be used for debugging. Note that the Admin API is disabled by default. To run a node with the Admin API enabled, use [C-Chain config flag`--coreth-admin-api-enabled:true`](/nodes/configure/chain-configs/c-chain#coreth-admin-api-enabled).

### Endpoint[​](#endpoint "Direct link to heading")

### `admin.setLogLevel`[​](#adminsetloglevel "Direct link to heading")
