...
Not recommended for use on Mainnet. See warning notice in [Keystore API](/docs/api-reference/keystore-api.md).
</Callout>

Export an asset from the C-Chain to X-Chain or P-Chain. If exporting to the X-Chain, you must call the
X-Chain's [`avm.import`](/docs/api-reference/x-chain/api.md#avmimport).
...
**DEPRECATED—instead use** [`avax.export`](/docs/api-reference/c-chain/api.md#avaxexport).

Send AVAX from the C-Chain to X-Chain or P-Chain. If exporting to the X-Chain, you must call the
X-Chain's [`avm.import`](/docs/api-reference/x-chain/api.md#avmimport) with assetID `AVAX`
...
**DEPRECATED—instead use** [`avax.import`](/docs/api-reference/c-chain/api.md#avaximport)
