...
<Accordion>
<AccordionItem title="Bech32 and NetworkID Mapping">
...
The prefix is simply the string `\x1AAvalanche Signed Message:\n`, where `0x1A` is the length of the prefix text and `length(message)` is an [integer](/api-reference/standards/serialization#integer) of the message size.

### Gantt Pre-Image Specification[​](#gantt-pre-image-specification "Direct link to heading")
...
Cryptography in Ethereum Virtual Machine[​](#cryptography-in-ethereum-virtual-machine "Direct link to heading")
---------------------------------------------------------------------------------------------------------------
...
Cryptography in Other Virtual Machines[​](#cryptography-in-other-virtual-machines "Direct link to heading")
-----------------------------------------------------------------------------------------------------------
