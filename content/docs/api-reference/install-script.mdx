---
title: AvalancheGo Install Script
---
...
How-to: [Run an Avalanche Node Using the Install Script](/nodes/run-a-node/using-install-script/installing-avalanche-go)

If you want to run a node in a more complex environment, like in a docker or Kubernetes container, or as a part of an installation orchestrated using a tool like Terraform, this installer probably won't fit your purposes. See here for how to run AvalancheGo in a [Docker container](/tooling/guides/run-with-docker).